...
from HannahRobot.plugins import ALL_MODULES
from HannahRobot.plugins.helper_funcs.chat_status import is_user_admin
from HannahRobot.plugins.helper_funcs.misc import paginate_plugins
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("HannahRobot.plugins." + module_name)
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                text="🗄 Source code",
                                url="https://github.com/Mr-Dark-Prince/HannahRobot",
                            )
                        ],
                    ]
                ),
