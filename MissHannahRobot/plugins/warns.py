...
from HannahRobot.plugins.helper_funcs.misc import split_message
from HannahRobot.plugins.helper_funcs.string_handling import split_quotes
from HannahRobot.plugins.log_channel import loggable
from HannahRobot.plugins.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Hannah's sticker
        keyboard = None
        log_reason = (
